...
const STAT_CARDS = [
  { key: 'pending' as const, label: 'Pending', color: 'bg-yellow-100 dark:bg-yellow-900' },
  { key: 'in_progress' as const, label: 'In Progress', color: 'bg-blue-100 dark:bg-blue-900' },
  { key: 'completed' as const, label: 'Completed', color: 'bg-green-100 dark:bg-green-900' },
  { key: 'rejected' as const, label: 'Rejected', color: 'bg-red-100 dark:bg-red-900' },
  { key: 'cancelled' as const, label: 'Cancelled', color: 'bg-gray-100 dark:bg-gray-800' },
  { key: 'overdue' as const, label: 'Overdue', color: 'bg-orange-100 dark:bg-orange-900' },
];
            ...
            <Pressable
              ...
              onPress={() =>
                key !== 'overdue'
                  ...
                  ? router.push({ pathname: '/(ot)/tasks' as any, params: { status: key } })
                  : undefined
              }
            >
              <Text className="text-3xl font-bold text-gray-900 dark:text-white">{stats[key]}</Text>
